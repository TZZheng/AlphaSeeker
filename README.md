...
![XOM Investment Memo — generated by AlphaSeeker harness runtime](docs/examples/assets/xom_investment_memo.png)

> Cover image: AI-generated via MiniMax. The memo itself ([XOM investment memo](docs/examples/AAPL_analysis_report.md)) was produced by the harness runtime — from a prompt to a 409-line cross-domain investment report in a single run.
