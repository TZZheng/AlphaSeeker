...
- Let source work be driven by the investment question. Do not prebuild every possible institutional artifact; gather the evidence needed to test the claimed conclusion strength. If the team asks whether a stronger conclusion needs valuation, consensus, peer, scenario, regulatory, customer, or competitive evidence, help obtain the smallest useful version of that evidence or explain why it is unavailable.
...
4. Send the orchestrator and writer a short source brief:
   ...
   - which next evidence category seems most likely to change recommendation, confidence, or framing if the team wants a stronger conclusion.
